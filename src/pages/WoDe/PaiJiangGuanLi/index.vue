<template>
  <div class="Page">
    <MainPageContainer :ShowMainHeader="true" :MainHeaderTitle="`派奖管理`" :ShowMainHeaderBack="true" :ShowMainHeaderMore="true" :MainHeaderMoreText="`派奖记录`" :MainHeaderMoreClick="() => { this.$router.push({ name: 'PaiJiangJiLu' }) }">
